...
public class autonomusFacingPitRed extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        thanosCar.encoderDrive(0.2,15,15,10);
        thanosCar.encoderTurn(80,1);
        thanosCar.encoderDrive(0.2,28,28,10);
        thanosCar.encoderTurn(20,-1);
        thanosCar.encoderDrive(0.1,20,20,5);
        thanosCar.encoderTurn(58,1);
        //thanosCar.encoderTurn(110,1);
        thanosCar.encoderDrive(0.2,50,50,5);
        ...
        thanosCar.encoderStrafe(0.2,10,10,5);
        thanosCar.encoderDrive(0.2,-70,-70,7);
